...
class TTTBoard(qtw.QGraphicsScene):
    ...
    def __init__(self):
        ...
        # obviously the best solution here is to use a resource file alas we won't do that
    ...
    def mousePressEvent(self, event: 'QGraphicsSceneMouseEvent') -> None:
        position = event.buttonDownScenePos(qtc.Qt.LeftButton)
        for square, qrect in enumerate(self.square_rects):
            # IMPORTANT MAYBE I COULD USE THIS IDEA FOR THE GRAPH STUFF?????
